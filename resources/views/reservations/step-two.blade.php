    ...
    <div class="flex flex-col md:flex-row">
      ...
      <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
       <div class="w-full">
        ...
        <div class="w-100 p-1 text-xs font-medium leading-none text-center text-blue-100 bg-blue-600 rounded-full">Step Two
           </div>
         </div>
     ...
     <div class="sm:col-span-6 pt-5">
      ...
      <div class="mt-1">
        <select id="table_id" name="table_id" class="form-multselect block w-full mt-1">
