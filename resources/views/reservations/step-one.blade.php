...
<div class="container w-full px-5 py-6 mx-auto">
    ...
    <div class="flex flex-col md:flex-row">
      ...
      <img class="object-cover w-full h-full" src="https://www.booking-wp-plugin.com/wp-content/uploads/2019/07/Banner-30-res.jpg" alt="">
      </div>
      <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
       <div class="w-full">
         <h3 class="mb-4 text-xl font-bold text-blue-600">Make Reservation</h3>
         <div class="w-full bg-gray-200 rounded-full">
        <div class="w-40 p-1 text-xs font-medium leading-none text-center text-blue-100 bg-blue-600 rounded-full">Step One
           </div>
        ...
        <div class="sm:col-span-6">
          <label for="res_date" class="block text-sm font-medium text-gray-700"> Reservation Date </label>
           ...
           <span class="text-xs text-bold">Please choose the time between 17:00-23:00.</span>
           @error('res_date')
           <div class="text-sm text-red-400">{{ $message }}</div>
           @enderror
        </div>
    <div class="sm:col-span-6">
      <label for="body" class="block text-sm font-medium text-gray-700">Guest Number</label>
      <div class="mt-1">
