<x-guest-layout>
  ...
  <div
      ...
      style="background-image: url('https://images.unsplash.com/photo-1600891964599-f61ba0e24092?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8cmVzdGF1cmFudCUyMGZvb2R8ZW58MHx8MHx8&w=1000&q=80')">
      <h1
        ...
        <span class="inline md:block">Welcome To Food For the Soul Restaurant</span>
      </h1>
        ...
        <div class="flex flex-wrap items-center sm:-mx-3">
          <div class="w-full md:w-1/2 md:px-3">
            ...
            > -->
              ...
              At our restaurant our aim is to serve delicious food made fresh with quality ingredients. 
              We put our hearts and souls into each dish to give you the authentic  experience; in a setting with a warm ambience, 
              traditional décor, and renowned hospitality.
              </p>
          ...
          <div class="w-full md:w-1/2">
            <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
              <img src="https://images.squarespace-cdn.com/content/v1/570b41834d088e29f6fab679/1579563796894-75E3JFSJQSG2BTUBDS6M/pille-riin-priske-xmuIgjuQG0M-unsplash.jpg" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="flex flex-wrap items-center -mx-3">
          <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
            <div class="w-full lg:max-w-md">
              ...
              <p class="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">Food for the Soul  Restaurant is one of the finest eateries in Nairobi. We offer an
                unparalleled experience of authentic, delicious and affordable Ethiopian food in a welcoming setting showing the true Spirit of Ethiopia.</p>
              <ul>
          ...
          <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0"><img
              ...
              src="https://www.newtimes.co.rw/uploads/imported_images/files/main/articles/2022/06/22/img-20220622-wa0027.jpg" alt="feature image"></div>
        </div>
      </div>
    </section>
